          ...
          <div className="lg:col-span-6 flex flex-col gap-6 order-2 lg:order-1">
            ...
            {student.github_url && (
              <a
                ...
                className="inline-flex items-center gap-2 font-jetbrains text-xs font-medium tracking-widest text-primary-container border border-primary-container/40 px-5 py-2.5 rounded hover:bg-primary-container/10 transition-all duration-300 w-fit"
              >
