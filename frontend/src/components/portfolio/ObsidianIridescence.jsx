            ...
            {student.github_url && (
              <div className="flex justify-center mt-6">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full glass-card border border-white/10 font-geist text-xs uppercase tracking-widest text-on-surface-variant hover:text-on-surface hover:border-primary/40 transition-all duration-300"
                >
